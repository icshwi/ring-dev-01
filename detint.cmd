...
dbLoadRecords("ro_hex_register.db", "SYS=$(SYS), DEV=$(DEV2), COM=$(COM2), OFF=50, SCAN=10 second, REG=STATUS2, DESC=Status 2, PRO=ics-dg.proto")
...
dbLoadRecords("evr_detector_controls.db", "SYS=$(SYS), EVR=$(EVR), TSEVT=$(SYNC_EVNT_LETTER)")
